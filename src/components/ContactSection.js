...
const ContactSection = () => {
  ...
  const [submissionStatus, setSubmissionStatus] = useState(null); // 'success', 'error', or 'submitting'
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // Send the form data to your new API endpoint
    ...
    <section id="contact" className="py-24 bg-neutral-100 dark:bg-neutral-900">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
          {/* Contact Information (no changes needed) */}
          <div className="space-y-12">
            <div className="space-y-8">
                <div className="flex items-start space-x-4">
                  <Mail className="w-6 h-6 text-neutral-900 dark:text-neutral-100 mt-1" />
                  <div>
                    <h3 className="text-lg font-light text-neutral-900 dark:text-neutral-100 mb-1">Email</h3>
                    <a href="mailto:castillop92@gmail.com" className="text-neutral-600 dark:text-neutral-400 hover:text-neutral-900 dark:hover:text-neutral-100 transition-colors">
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h3 className="text-lg font-light text-neutral-900 dark:text-neutral-100 mb-1">Location</h3>
                    <p className="text-neutral-600 dark:text-neutral-400">Houston, TX, USA</p>
                  </div>
                </div>
              </div>
              <div className="space-y-4">
                <h3 className="text-lg font-light text-neutral-900 dark:text-neutral-100">Connect</h3>
                <div className="flex space-x-4">
                  <a href="https://www.linkedin.com/in/petecastillo92/" target="_blank" rel="noopener noreferrer" className="p-2 border border-neutral-300 dark:border-neutral-700 hover:border-neutral-900 dark:hover:border-neutral-100 transition-colors">
                    <Linkedin className="w-5 h-5 text-neutral-900 dark:text-neutral-100" />
                  </a>
                  <a href="https://github.com/PJC2010" target="_blank" rel="noopener noreferrer" className="p-2 border border-neutral-300 dark:border-neutral-700 hover:border-neutral-900 dark:hover:border-neutral-100 transition-colors">
